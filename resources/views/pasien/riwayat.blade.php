...
<head>
  ...
  <title>ChieMedical | Riwayat</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('riwayatPasien') }}" class="nav-link active">
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>Charlie</td>
                        <td>01/04/2025</td>
                        <td>Batuk kering dan sakit tenggorokan.</td>
                        <td>Sirup Obat Batuk.</td>
                        <td>75000.</td>
                    </tr>
                    <tr>
                        <td>4</td>
                        ...
                        <td>Dina</td>
                        <td>02/04/2025</td>
                        <td>Nyeri otot dan badan pegal.</td>
                        <td>Ibuprofen & Minyak Gosok.</td>
                        <td>90000.</td>
                    </tr>
                    <tr>
                        <td>5</td>
                        ...
                        <td>Edwin</td>
                        <td>03/04/2025</td>
                        <td>Gangguan tidur akibat stres.</td>
                        <td>Obat Tidur Herbal.</td>
                        <td>120000.</td>
                    </tr>
                  </tbody>
                </table>
