              ...
              <form>
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputName" placeholder="Enter nama obat">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputKemasan">Jenis Kemasan</label>
                    <input type="text" class="form-control" id="exampleInputKemasan" placeholder="Enter jenis kemasan">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputHarga">Harga</label>
                    <input type="text" class="form-control" id="exampleInputHarga" placeholder="Enter harga obat">
                  </div>
                </div>
                <!-- /.card-body -->
